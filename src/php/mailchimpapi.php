 ...
 * 
 */
namespace TheApi\MailChimp;
/**
 * Super-simple, minimum abstraction MailChimp API v3 wrapper
 * MailChimp API v3: http://developer.mailchimp.com
 * @author Louis Lister <support@wonkasoft.com>
 * @version 1.0
 */
class MailChimp
{
    ...
    */
    ...
    private function makeRequest($http_verb, $method, $args = array(), $timeout = 10)
    {
        ...
        curl_setopt($ch, CURLOPT_USERAGENT, 'MailChimp API Library (https://github.com/Wonkasoft/MailChimpAPI)');
